...
import MarkdownElement from 'web-app/src/modules/components/MarkdownElement';
import Head from 'web-app/src/modules/components/Head';
import AppContent from 'web-app/src/modules/components/AppContent';
import Demo from 'web-app/src/modules/components/Demo';
import AppFrame from 'web-app/src/modules/components/AppFrame';
import AppTableOfContents from 'web-app/src/modules/components/AppTableOfContents';
import Ad from 'web-app/src/modules/components/Ad';
import EditPage from 'web-app/src/modules/components/EditPage';
import MarkdownDocsContents from 'web-app/src/modules/components/MarkdownDocsContents';
import PageContext from 'web-app/src/modules/components/PageContext';
import {
  getHeaders,
  getTitle,
  getDescription,
  demoRegexp,
} from 'web-app/src/modules/utils/parseMarkdown';
import { pageToTitleI18n } from 'web-app/src/modules/utils/helpers';
import { LANGUAGES_IN_PROGRESS } from 'web-app/src/modules/constants';
import Link from 'web-app/src/modules/components/Link';
...
const SOURCE_CODE_ROOT_URL = 'https://github.com/mui-org/material-ui/blob/master/web-app/src';
