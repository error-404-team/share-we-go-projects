...
import NProgressBar from '@material-ui/web-app/NProgressBar';
import FormatTextdirectionLToR from '@material-ui/icons/FormatTextdirectionLToR';
import FormatTextdirectionRToL from '@material-ui/icons/FormatTextdirectionRToL';
import Link from 'web-app/src/modules/components/Link';
import AppDrawer from 'web-app/src/modules/components/AppDrawer';
import AppSearch from 'web-app/src/modules/components/AppSearch';
import Notifications from 'web-app/src/modules/components/Notifications';
import MarkdownLinks from 'web-app/src/modules/components/MarkdownLinks';
import PageTitle from 'web-app/src/modules/components/PageTitle';
import { LANGUAGES_LABEL } from 'web-app/src/modules/constants';
import { pathnameToLanguage } from 'web-app/src/modules/utils/helpers';
import { useChangeTheme } from 'web-app/src/modules/components/ThemeContext';

const LOCALES = { zh: 'zh-CN', pt: 'pt-BR', es: 'es-ES' };
const CROWDIN_ROOT_URL = 'https://translate.material-ui.com/project/material-ui-web-app/';
