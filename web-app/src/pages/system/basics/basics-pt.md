...
O styled-system fez um ótimo trabalho [explicando como ele funciona](https://github.com/jxnblk/styled-system/blob/master/web-app/how-it-works.md#how-it-works). Ele pode ajudar a construir um modelo mental para esse conceito de "função de estilo".
...
- [Twitter Bootstrap](https://getbootstrap.com/web-app/4.1/utilities/borders/) introduziu lentamente nomes de classes atômicas em v2, v3 e v4. Usamos a maneira como eles agrupam suas "classes de ajuda" como inspiração.
