...
styled-system在[解释它如何工作](https://github.com/jxnblk/styled-system/blob/master/web-app/how-it-works.md#how-it-works)方面做得很好 。 它可以协助为这种“style function”概念建立神经模型。
...
- [Twitter Bootstrap](https://getbootstrap.com/web-app/4.1/utilities/borders/) 在v2，v3, 和v4中一步步介绍了原子类名 他们使用 `Helper classes` 聚合它们的方式给了我们启发。
