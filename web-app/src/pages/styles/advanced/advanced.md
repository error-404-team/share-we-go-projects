...
We **encourage** you to read this MDN paragraph: [How is specificity calculated?](https://developer.mozilla.org/en-US/web-app/Web/CSS/Specificity#How_is_specificity_calculated)
...
JSS [provides a mechanism](https://github.com/cssinjs/jss/blob/master/web-app/setup.md#specify-the-dom-insertion-point) to control this situation.
