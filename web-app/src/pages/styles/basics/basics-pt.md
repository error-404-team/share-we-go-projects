...
- 💅 Você pode esperar [as mesmas vantagens](https://www.styled-components.com/web-app/basics#motivation) que styled-components.
...
- 🧩 É extensível através de uma API de [plugin](https://github.com/cssinjs/jss/blob/master/web-app/plugins.md).
- ⚡️Ela usa [JSS](https://github.com/cssinjs/jss) em seu núcleo – um [alto desempenho](https://github.com/cssinjs/jss/blob/master/web-app/performance.md) JavaScript para o compilador CSS, que funciona em tempo de execução e no lado do servidor.
