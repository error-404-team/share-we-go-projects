...
- 💅 You can expect [the same advantages](https://www.styled-components.com/web-app/basics#motivation) as styled-components.
...
- 🧩 It's extensible via a [plugin](https://github.com/cssinjs/jss/blob/master/web-app/plugins.md) API.
- ⚡️ It uses [JSS](https://github.com/cssinjs/jss) at its core – a [high performance](https://github.com/cssinjs/jss/blob/master/web-app/performance.md) JavaScript to CSS compiler which works at runtime and server-side.
