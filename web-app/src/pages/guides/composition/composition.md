...
This can be changed by passing a [React component](https://reactjs.org/web-app/components-and-props.html#function-and-class-components) to the `component` property.
