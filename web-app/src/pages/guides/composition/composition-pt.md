...
- [Componentes React.forwardRef](https://reactjs.org/web-app/react-api.html#reactforwardref)
- [Componentes React.lazy](https://reactjs.org/web-app/react-api.html#reactlazy)
- [Componentes React.memo](https://reactjs.org/web-app/react-api.html#reactmemo)
...
Cobrimos apenas os dois casos de uso mais comuns. Para mais informações, consulte [esta seção na documentação oficial do React](https://reactjs.org/web-app/forwarding-refs.html).
