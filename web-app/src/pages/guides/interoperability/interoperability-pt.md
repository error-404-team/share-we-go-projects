...
Outra abordagem é usar os caracteres `&&` em styled-components para [aumentar a especificidade](https://www.styled-components.com/web-app/advanced#issues-with-specificity) repetindo o nome da classe. Você deve evitar o uso de `!important`.
