...
- **host component**: a DOM node type in the context of `react-dom`, e.g. a `'div'`. См. также [React Implementation Notes:](https://reactjs.org/web-app/implementation-notes.html#mounting-host-elements).
