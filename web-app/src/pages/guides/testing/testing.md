...
Please refer to the [enzyme API documentation](https://airbnb.io/enzyme/web-app/api/mount.html) for further details on the `mount` function.
...
Please refer to the [enzyme API documentation](https://airbnb.io/enzyme/web-app/api/shallow.html) for further details on the `shallow` function.
...
Please refer to the [enzyme API documentation](https://airbnb.io/enzyme/web-app/api/render.html) for further details on the `render` function.
