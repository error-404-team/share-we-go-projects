...
[Add your changes on GitHub](https://github.com/mui-org/material-ui/blob/master/web-app/src/pages/guides/migration-v3/migration-v3.md).
...
This allows us to rely on [Hooks](https://reactjs.org/web-app/hooks-intro.html) (we no longer use the class API).
...
- Remove the first option argument of `withTheme()`.
  ...
  It matches the [emotion API](https://emotion.sh/web-app/introduction) and the [styled-components API](https://www.styled-components.com).
