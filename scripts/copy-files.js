 ...
 * like import Typography from 'share-we-go-ui/Typography' are tree-shakeable.
 *
...
async function run() {
  try {
    ...
    await Promise.all(
      [
        // use enhanced readme from workspace root for `share-we-go-ui`
        packageData.name === 'share-we-go-ui' ? '../../README.md' : './README.md',
        '../../CHANGELOG.md',
        '../../LICENSE',
