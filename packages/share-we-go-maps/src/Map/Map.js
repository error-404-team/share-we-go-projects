...
GMap.propTypes = {
    ...
    options: PropTypes.oneOfType([
      ...
      PropTypes.shape({
        ...
        fullscreenControlOptions: PropTypes.oneOfType([
          ...
          PropTypes.func,
          PropTypes.shape({
            position: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
          }),
        ]),
        ...
        mapTypeControlOptions: PropTypes.oneOfType([
          ...
          PropTypes.func,
          PropTypes.shape({
            mapTypeIds: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
            position: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
            style: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
          }),
        ]),
        mapTypeId: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
  ...
  setMapTypeId: PropTypes.oneOfType([PropTypes.element, PropTypes.func, PropTypes.string]),
...
evtNames.forEach(e => (GMap.propTypes[camelize(e)] = PropTypes.func));
