...
function App() {
  ...
  const umd = await fse.readFile(
    path.join(rootPath, 'packages/share-we-go-ui/build/umd/share-we-go-ui.development.js'),
    'utf8',
  );
...
async function startBrowser() {
  ...
  const browser = await puppeteer.launch({
    args: [
      ...
      // https://github.com/GoogleChrome/puppeteer/blob/5d6535ca0c82efe2ca50450818d5fb20aa015658/web-app/troubleshooting.md#setting-up-chrome-linux-sandbox
