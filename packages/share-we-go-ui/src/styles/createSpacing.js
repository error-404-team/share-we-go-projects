      ...
      if (process.env.NODE_ENV !== 'production') {
        warning(
          ...
          [
            ...
            '',
            'You can use the `https://github.com/mui-org/material-ui/tree/master/packages/share-we-go-codemod/README.md#theme-spacing-api` migration helper to make the process smoother.',
          ].join('\n'),
        );
        warnOnce = true;
      }
