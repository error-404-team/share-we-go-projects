...
import { chainPropTypes } from 'share-we-go-utils';
...
Popper.propTypes = {
   ...
   * To learn how to create a modifier, [read the modifiers documentation](https://github.com/FezVrasta/popper.js/blob/master/web-app/_includes/popper-documentation.md#modifiers--object).
   */
