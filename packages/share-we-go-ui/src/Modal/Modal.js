...
import { useTheme } from 'share-we-go-styles';
import { elementAcceptingRef } from 'share-we-go-utils';
  ...
  return (
    <Portal ref={handlePortalRef} container={container} disablePortal={disablePortal}>
      {/*
          ...
          https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/web-app/rules/no-static-element-interactions.md
        */}
      <div
        data-mui-test="Modal"
        ref={handleRef}
