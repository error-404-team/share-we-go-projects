...
module.exports = {
  ...
  plugins: ['babel', 'mocha', 'share-we-go-ui', 'react-hooks'],
  settings: {
    'import/resolver': {
      webpack: {
        config: path.join(__dirname, './web-app/webpackBaseConfig.js'),
      },
    },
  },
  /**
  ...
  rules: {
    ...
    'share-we-go-ui/docgen-ignore-before-comment': 'error',
    'share-we-go-ui/restricted-path-imports': 'error',
